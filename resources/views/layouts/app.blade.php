...
<head>
    ...
    <link href="{{ asset('resources/assets/css/plugins/jquery.dataTables.css') }}" rel="stylesheet/less" type="text/css">
    <link href="{{ asset('resources/assets/css/plugins/dataTables.bootstrap.css') }}" rel="stylesheet/less" type="text/css">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('/resident/clearance') }}"><i class="fa fa-file-text-o"></i> Barangay Clearance</a>
                        </li>
                        <li>
                         ...
                         <li>
                           ...
                           <li>
                            <a href="{{ url('/resident/message') }}"><i class="fa fa-wechat"></i> Check Message </a>
                        </li>
                           <li>
                            <a href="{{ url('/resident/schedule') }}"><i class="fa  fa-calendar"></i> Check Schedule </a>
                        </li>
                           <li>
